...
export function VendorRegisterForm({ track }: { track: ApplicationType }) {
    const router = useRouter();
    const isFood = track === 'FOOD';
    ...
    const categoryOptions = isFood ? FOOD_CATEGORIES : CATEGORIES;
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <PageContainer>
                <div className="text-center mb-6">
                    ...
                    <h1 className="font-herb text-3xl text-brand-red">
                        {isFood ? 'Food Court Registration' : 'Vendor Registration'}
                    </h1>
                    <p className="text-gray-400 text-xs font-medium mt-1">
                        Daawat-e-Ramzaan • Season 6 • 2027 • {isFood ? 'Food Court' : 'Fashion & Lifestyle'}
                    </p>
                </div>
                ...
                {(step === 'PHONE' || step === 'OTP') && (
                    <>
                        {isFood && (
                            <div className="bg-brand-red/5 border border-brand-red/20 text-gray-600 p-3 rounded-xl text-xs leading-relaxed mb-4">
                                {FOOD_NOTICE}
                            </div>
                        )}
                        <VendorOtpStep
                        ...
                        {step === 'PHONE' && (
                            <p className="text-center text-xs text-gray-400 mt-4">
                                {isFood ? (
                                    <>Not a food vendor? <Link href="/vendor/register" className="text-brand-blue font-bold underline">Fashion &amp; Lifestyle registration</Link></>
                                ) : (
                                    <>Are you a food vendor? <Link href="/vendor/register/food" className="text-brand-blue font-bold underline">Food Court registration</Link></>
                                )}
                            </p>
                        )}
                    </>
                ...
                {step === 'DETAILS' && (
                    <form onSubmit={handleDetailsNext} className="flex flex-col gap-4">
                        ...
                        <SectionTitle>{isFood ? 'Food Business Information' : 'Brand Information'}</SectionTitle>
                        ...
                        <Field label={isFood ? 'What food items will you be showcasing?' : 'What products will you be showcasing?'}>
                ...
                {step === 'IMAGES' && (
                    <div className="flex flex-col gap-5">
                        ...
                        />
                        <UploadGroup
                            label={isFood ? 'Food Photographs (5–10)' : 'Product Photographs (5–10)'}
                            hint={isFood ? 'Upload 5 to 10 photos of your food items' : 'Upload 5 to 10 product photos'}
                            multiple
                            loading={loading}
                ...
                {step === 'REVIEW' && (
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="bg-white rounded-2xl p-5 border border-brand-blue/10 text-sm space-y-2">
                            <p><strong>Track:</strong> {isFood ? 'Food Court' : 'Fashion & Lifestyle'}</p>
