...
export default function TargetedAppUsersPage() {
        ...
        <div className="min-h-screen bg-gray-100 p-8 font-sans">
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Targeted App Users</h1>
                        <p className="mt-2 text-sm text-gray-700">Broadcasts, push notifications, and lists for people using the Daawat-e-Ramzaan app.</p>
                    </div>
